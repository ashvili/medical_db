...
resourcestring
  ...
  cxSEditButtonOK = 'OK';
  cxSEditDateConvertError = 'Не удалось сконвертировать в дату';//'Could not convert to date';
  cxSEditInvalidRepositoryItem = 'Элемент репозитория неприемлем';//'The repository item is not acceptable';
  cxSEditNumericValueConvertError = 'Не удалось преобразовать в числовое значение';//'Could not convert to numeric value';
  cxSEditPopupCircularReferencingError = SCircularReferencingError;
  cxSEditPostError = 'Во время сохранения значения произошла ошибка';  //'An error occurred during posting edit value';
  cxSEditTimeConvertError = 'Не удалось преобразовать в тип значения время';     //'Could not convert to time';
  cxSEditValidateErrorText = 'Неверное входное значение. Используйте клавишу escape, чтобы отказаться от изменений'; //'Invalid input value. Use escape key to abandon changes';
  cxSEditValueOutOfBounds = 'Значение выходит за границы допустимого диапазона';  //'Value out of bounds';
  ...
  // Combo
  cxSNoMatchesFound                  = 'Совпадений не найдено";';    //'No matches found';

  // Blob
  cxSBlobButtonOK                    = '&OK';
  cxSBlobButtonCancel                = 'Отмена';
  cxSBlobButtonClose                 = 'Закрыть';
  cxSBlobMemo                        = '(MEMO)';
  ...
  // popup menu items
  cxSMenuItemCaptionCut              = 'Вырезать';
  cxSMenuItemCaptionCopy             = 'Копировать';
  cxSMenuItemCaptionPaste            = 'Вставить';
  cxSMenuItemCaptionDelete           = 'Удалить';
  cxSMenuItemCaptionLoad             = 'Загрузить...';
  cxSMenuItemCaptionSave             = 'Сохранить как...';
  cxSMenuItemCaptionAssignFromWebCam = 'Получить из камеры...';

  // Date
  cxSDatePopupClear                  = 'Очистить';
  cxSDatePopupNow                    = 'Сейчас';
  cxSDatePopupOK                     = 'OK';
  cxSDatePopupToday                  = 'Сегодня';
  cxSDatePopupCancel                 = 'Отменить';
  cxSDateError                       = 'Неверная дата';

  // Calculator
  scxSCalcError                      = 'Ошибка';
  ...
  cxNavigatorHint_Prior = 'Предыдущая запись';
  cxNavigatorHint_PriorPage = 'Предыдущая страница';
  cxNavigatorHint_Next = 'Следующая запись';
  cxNavigatorHint_NextPage = 'Следующая страница';
  cxNavigatorHint_Last = 'Последняя запись';
  cxNavigatorHint_Insert = 'Вставить запись';
  cxNavigatorHint_Append = 'Добавить запись';
  cxNavigatorHint_Delete = 'Удалить запись';
  cxNavigatorHint_Edit = 'Редактировать запись';
  cxNavigatorHint_Post = 'Сохранить изменения';
  cxNavigatorHint_Cancel = 'Отменить изменения';
  ...
  cxNavigatorHint_Filter = 'Фильтр данных';
  cxNavigator_DeleteRecordQuestion = 'Удалить запись?';
  cxNavigatorInfoPanelDefaultDisplayMask = '[RecordIndex] из [RecordCount]';

  // BreadcrumbEdit
  sdxBreadcrumbEditInvalidPath = 'Не удалось найти "%s". Проверьте правильность и попробуйте снова.';
  sdxBreadcrumbEditInvalidStreamVersion = 'неверная версия данных: %d';
  ...
  // ToggleSwitch
  sdxDefaultToggleSwitchOffText = 'Выкл';
  sdxDefaultToggleSwitchOnText = 'Вкл';

  // DateTimeWheelPicker
  sdxDateTimeWheelPickerHours = 'Часы';
  sdxDateTimeWheelPickerMinutes = 'Минуты';
  sdxDateTimeWheelPickerSeconds = 'Секунды';

  // Sparkline
  sdxSparklineNoData = '<Нет данных>';
  ...
  // RangeControl
  sdxRangeControlRangeIsEmpty = 'Диапазон пуст';
