...
resourcestring
  ...
  cxSGridSortColumnAsc = 'Сортировка по возрастанию';
  cxSGridSortColumnDesc = 'Сортировка по убыванию';
  cxSGridClearSorting = 'Очистить сортировку';
  ...
  cxSGridShowFindPanel = 'Панель поиска';
