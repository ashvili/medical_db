...
resourcestring
  ...
  scxGridNoDataInfoText = '<Нет данных для отображения>';

  scxGridFilterRowInfoText = 'Click here to define a filter';
  scxGridNewItemRowInfoText = 'Click here to add a new row';

  scxGridFindPanelClearButtonCaption = 'Очистить';
  scxGridFindPanelFindButtonCaption = 'Найти';
  scxGridFindPanelInfoText = 'Введите текст для поиска...';

  scxGridFilterIsEmpty = '<Фильтр не задан>';
  ...
  scxGridInplaceEditFormButtonCancel = 'Отмена';
  scxGridInplaceEditFormButtonClose = 'Закрыть';
  scxGridInplaceEditFormButtonUpdate = 'Сохранить';
  scxGridInplaceEditFormSaveChangesQuery = 'Данные изменены. Сохранить измменения?';//'Your data is modified. Do you want to save the changes?';
